      ...
      >
        <div class="px-6 h-16 flex items-center justify-between">
          ...
          <RouterLink to="/" class="flex items-center space-x-3 group">
            <div class="icon-container-primary !w-11 !h-11 group-hover:rotate-[360deg] transition-transform duration-1000 ease-in-out relative overflow-hidden">
               <MapPin class="w-6 h-6 text-white relative z-10 animate-premium-float" stroke-width="2.5" />
          ...
          <div class="hidden lg:flex items-center gap-x-1 xl:gap-x-2">
            ...
            <RouterLink 
              v-if="!store.user"
              to="/login"
              class="px-3 xl:px-4 py-2 rounded-xl text-[10px] xl:text-xs font-black text-slate-500 hover:text-white bg-slate-50 hover:bg-slate-900 border border-slate-200 transition-all flex items-center gap-2 group/admin shadow-sm hover:shadow-lg overflow-hidden"
            >
              <div class="w-7 h-7 rounded-xl bg-slate-900 flex items-center justify-center group-hover/admin:bg-primary-500 transition-all duration-300 relative overflow-hidden">
                <Shield class="w-4 h-4 text-white animate-pulse-glow relative z-10" />
                <div class="absolute inset-0 bg-white/10 opacity-0 group-hover/admin:opacity-100 transition-opacity"></div>
              </div>
              ACCESO ADMIN
            </RouterLink>
            ...
            >
              <div class="w-7 h-7 rounded-xl bg-red-600 flex items-center justify-center group-hover/out:scale-110 transition-transform">
                <LogOut class="w-4 h-4 text-white group-hover/out:-translate-x-0.5 transition-transform" />
              </div>
              SALIR
            </button>
            ...
            >
              <Heart class="w-4 h-4 group-hover/part:scale-125 transition-transform animate-pulse" stroke-width="2.5" />
              Participar
            </RouterLink>
          </div>
